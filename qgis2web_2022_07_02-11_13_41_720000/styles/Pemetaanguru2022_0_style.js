...
var style_Pemetaanguru2022_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("jmlh_guru");
    var labelText = "";
    size = 0;
    ...
    if (value > 0.000000 && value <= 276.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 276.000000 && value <= 551.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 551.000000 && value <= 826.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 826.000000 && value <= 1100.000000) {
            style = [ new ol.style.Style({
